...
<table>
  ...
  <tbody>
    ...
    <tr><td nowrap><img alt='New Modern DangoPlayer Icon' width='48' src='https://brunochanrio.github.io/DangoPlayer/assets/FutureDangoIcon.png'/></td><td>The new icon of the modern DangoPlayer (<b>com.brunochanrio.dangoplayeruni</b>) app, which will start to be used starting with the next version (6.0usagi). Notice that the icon has a colorful gradient background composed of Pink, Mint Green, Yellow and Purple colors, the Dango colors are Light Pink, Light Mint Green and Light Yellow, and the Dango stick color are Light Purple</td></tr>
...
This is why we are removing the DangoPlayer Uni migration code from thr modern DangoPlayer app beginning with the next version (6.0usagi)
